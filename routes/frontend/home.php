...
Route::get('terms', [TermsController::class, 'index'])
    ...
    // Route::get("portal/file/{id}",[MerchantSignUpController::class, 'file']);
    // Route::get("portal/files",[MerchantSignUpController::class, 'files']);
    // Route::get("portal/live/file/{id}",[MerchantSignUpController::class, 'file_live']);
    // Route::get("portal/live/files",[MerchantSignUpController::class, 'files_live']);
    // Route::get("portal/externalfile/{id}",[MerchantSignUpController::class, 'externalfile']);
    // Route::get("portal/externalfiles",[MerchantSignUpController::class, 'externalfiles']);
    // Route::get("portal/live/externalfile/{id}",[MerchantSignUpController::class, 'externalfile_live']);
    // Route::get("portal/live/externalfiles",[MerchantSignUpController::class, 'externalfiles_live']);
