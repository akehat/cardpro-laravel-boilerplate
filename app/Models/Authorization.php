    ...
    public static function showTable($request, $title = 'title')
    {
        ...
        if ($request->ajax()) {
            ...
            if ($queryCount < config('app.json_table_limit')) {
                ...
                return view("frontend.pages.portal.holdsViewer", [
                ...
                return view("frontend.pages.portal.tableHoldViewer", ['columns' => $columns, 'title' => $title]);
            }
        }
    }
...
// Save and refresh the model new
    ...
    public static function makeHold($merchant,$currency,$amount_in_cents,$card,$userID,$api_userID,$apikeyID=0){
        ...
        $holdMade=self::create([
            ...
            'finix_created_at' => $value->created_at,
            'finix_updated_at' => $value->updated_at,
