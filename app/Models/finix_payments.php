    ...
    public static function showTable($request, $title = 'title')
    {
        ...
        if ($request->ajax()) {
            ...
            if ($queryCount < config('app.json_table_limit')) {
                ...
                return view("frontend.pages.portal.paymentsViewer", [
...
$value->created_at = $value->created_at != null ? (new DateTime($value->created_at))->format('Y-m-d H:i:s') : null;
    ...
    public static function makePayment($merchant,$currency,$amount_in_cents,$card,$userID,$api_userID,$apikeyID=0,$descriptor=null){
        ...
        $payment=merchantsController::makePaymentMinReq(config("app.api_username"),config("app.api_password"),$merchant,$currency,$amount_in_cents,$card,$endpoint,[],$data);
